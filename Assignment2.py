...
list_new=[]
input_file=open("/Users/denes/Downloads/workshop_2/data/apache_log.txt")              # Change this path to your working directory with data file
...
with open("/Users/denes/Downloads/workshop_2/data/apache_log_export.csv", 'w', newline='') as export_file:         # Change this path to your working directory where the export file is saved
    for i in list_new:
